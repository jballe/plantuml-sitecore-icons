param(
    ...
    [string]$SourcesFiles = (Join-Path $PSScriptRoot "by-type/sc10-cloud-archictecture"),
    [string]$PngImagesFolder = (Join-Path $PSScriptRoot "sprites"), #(Join-Path $PSScriptRoot "by-type/sc10-cloud-archictecture"),
    [string]$SpritesFolder = (Join-Path $PSScriptRoot "sprites"), #(Join-Path $PSScriptRoot "by-type/sc10-cloud-archictecture"),
