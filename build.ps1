param(
    ...
    [string]$SourcesFiles = (Join-Path $PSScriptRoot "by-type/sc10-cloud-architecture"),
    [string]$PngImagesFolder = (Join-Path $PSScriptRoot "sprites"), #(Join-Path $PSScriptRoot "by-type/sc10-cloud-architecture"),
    [string]$SpritesFolder = (Join-Path $PSScriptRoot "sprites"), #(Join-Path $PSScriptRoot "by-type/sc10-cloud-architecture"),
